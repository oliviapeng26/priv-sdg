...
THE PROBLEM
    run_synthcity_sample_size_sweep.py grows num_train and num_test together, and they do different
...
Run from the repo root, venv active:
  python benchmark_tapas/diagnostics/run_disentangle_numtrain.py
  python benchmark_tapas/diagnostics/run_disentangle_numtrain.py --methods dpgan
"""
...
OUT_DIR = RESULTS_DIR / "extras" / "disentangle"
