...
NO NEW CODE PATH -- THIS IS run_dpgan_eps_sweep.py
    ...
    no logic of its own. It imports run_dpgan_eps_sweep.run_one_epsilon and calls it. Same
...
OUTPUT
    results/extras/dpgan_spike_diagnosis/privacy/eps{0.999,1.001}/
        effeps_dpgan_eps*.csv, effective_epsilon_*.csv, meta.json
    results/extras/dpgan_spike_diagnosis/privacy/raw_scores_dpgan_eps*.csv
    results/extras/dpgan_spike_diagnosis/privacy/eps_nudge_log.txt

Run from the repo root, env active:
  python benchmark_tapas/diagnostics/run_eps_nudge.py
  python benchmark_tapas/diagnostics/run_eps_nudge.py --epsilons 0.999
"""
...
SWEEP_SCRIPTS = BENCHMARK_DIR / "audits"
...
# run_dpgan_eps_sweep configures logging at import, pointing at the headline sweep's log.
