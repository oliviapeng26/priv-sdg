...
OUTPUT
    results/extras/dpgan_spike_diagnosis/recomputed_eff_eps.csv
...
Run from the repo root (CPU, seconds):
  python benchmark_tapas/diagnostics/recompute_eff_eps.py
  python benchmark_tapas/diagnostics/recompute_eff_eps.py --confidence 0.9
"""
